...
db.run('CREATE TABLE IF NOT EXISTS Comments(CommentID INTEGER PRIMARY KEY,Name TEXT,Content TEXT,Date TEXT,ArticleID INTEGER, FOREIGN KEY (ArticleID) REFERENCES Articles (ArticleID));',(err)=>{
    if(err) return console.log(err.message);
